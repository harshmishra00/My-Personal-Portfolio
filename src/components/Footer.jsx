...
const Footer = () => {
  return (
    <footer id="footer" className="footer-section w-full bg-[#f5f5f5] text-[#0f0f0f]">
      <div className="container mx-auto px-6 md:px-16 pt-20 md:pt-[160px] pb-16 md:pb-[120px] flex flex-col items-center text-center">
        <motion.p
          initial={{ opacity: 0, y: 30 }}
          whileInView={{ opacity: 1, y: 0 }}
          viewport={{ once: false }}
          className="text-base md:text-[18px] lg:text-[20px] font-sans mb-4 text-[#0f0f0f]/60 font-medium"
        >
        ...
        <motion.h2
          ...
          className="font-display text-[clamp(2.8rem,10vw,140px)] leading-[0.85] mb-6 md:mb-8 tracking-tighter uppercase font-black"
        >
      ...
      <div className="container mx-auto px-6 md:px-16 pb-10 md:pb-12">
