...
const Services = () => {
  return (
    <section id="services" className="bg-[#f5f5f3] text-[#0f0f0f] py-24 md:py-32 font-sans relative overflow-hidden transition-colors duration-700">
      <div className="container mx-auto px-6 md:px-12 max-w-7xl">
        ...
        >
          <p className="text-[12px] font-bold tracking-[0.2em] text-[#888888] uppercase mb-4">
            Core Competencies
          </p>
          <h2 className="font-display text-[clamp(3.5rem,8vw,8rem)] leading-[0.85] tracking-tighter uppercase text-[#0f0f0f]">
        ...
        <div className="w-full border-t border-black/10">
          {categories.map((category, idx) => (
            <motion.div
              ...
              className="group flex flex-col lg:flex-row py-12 md:py-16 border-b border-black/10 hover:bg-black/5 transition-colors duration-500 px-4 md:px-8 -mx-4 md:-mx-8 cursor-pointer"
            >
              {/* Category Identity */}
              <div className="w-full lg:w-1/3 mb-8 lg:mb-0 flex flex-col justify-center">
                <h3 className="font-display text-4xl md:text-5xl lg:text-6xl uppercase tracking-tighter text-[#0f0f0f] mb-2 lg:mb-4">
                  {category.name}
                </h3>
                <p className="text-[#666] text-sm md:text-base font-medium max-w-sm lg:group-hover:text-[#333] transition-colors duration-500">
                ...
                {category.tools.map((tool, tIdx) => {
                  ...
                  return (
                    <div key={tool.name} className="flex items-center gap-3">
                      ...
                      >
                        <div className="w-full h-full drop-shadow-[0_0_8px_rgba(0,0,0,0.15)]">
                          {tool.icon}
                        </div>
                      </motion.span>
                      <span className="font-display text-2xl md:text-3xl uppercase tracking-tight text-[#0f0f0f]/80 transition-colors duration-700">
                        {tool.name}
                      </span>
                    </div>
                  );
